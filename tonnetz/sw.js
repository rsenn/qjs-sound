...
const SHELL = ['./', 'index.html', 'lib/theory.js', 'lib/geometry.js', 'lib/harmony.js', 'lib/synth.js', 'lib/sequencer.js', 'lib/player.js', 'manifest.webmanifest', 'icon-192.png', 'icon-512.png', 'icon-maskable-512.png', 'apple-touch-icon.png'];
